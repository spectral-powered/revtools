...
class InstructionFactory internal constructor(val group: ClassGroup) {
    private val types get() = group.type
...
fun inst(group: ClassGroup, ctx: UsageContext, body: InstructionBuilder.() -> Instruction): Instruction =
    InstructionBuilderImpl(group, ctx).body()
...
fun insts(
    ...
    InstructionListBuilderImpl(group, ctx).body()
