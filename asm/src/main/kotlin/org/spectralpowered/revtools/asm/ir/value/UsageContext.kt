...
import org.spectralpowered.revtools.asm.ir.value.instruction.inst
...
interface UsageContext : ValueUsageContext, BlockUsageContext {
     ...
     */
    fun inst(group: ClassGroup, body: InstructionBuilder.() -> Instruction): Instruction = inst(group, this, body)
}
