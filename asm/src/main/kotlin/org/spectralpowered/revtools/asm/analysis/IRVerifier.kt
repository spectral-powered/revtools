...
class IRVerifier(classGroup: ClassGroup) : MethodVisitor {
    override val group: ClassGroup = classGroup
    ...
    constructor(classGroup: ClassGroup, ctx: UsageContext) : this(classGroup) {
